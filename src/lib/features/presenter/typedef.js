/**
 * @typedef {{
 *     type: (import('$lib/features/presenter/constants').TRANSITION_CSS),
 *     property: string,
 *     from: string,
 *     to: string,
 *     delay?: number
...
/**
 * @typedef {{
 *     type: (import('$lib/features/presenter/constants').FADE_IN),
 *     from?: string,
 *     to?: string,
 *     delay?: number
 *     duration?: number
...
/**
 * @typedef {{
 *     type: (import('$lib/features/presenter/constants').FADE_OUT),
 *     from?: string,
 *     to?: string,
 *     delay?: number
 *     duration?: number
