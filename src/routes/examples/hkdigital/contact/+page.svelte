  ...
  <div class="px-20p w-10/12 h-full bg-blue-950 text-white">
    ...
    <form method="post" action="/contact">
      <div class="mb-5p">
        ...
        <div class="flex space-x-4">
          ...
          <label
            ...
            class="inline-flex items-center text-surface-50"
          >
            <input type="radio" name="aanhef" value="mevrouw" required />
          ...
          <label
            ...
            class="inline-flex items-center text-surface-50"
          >
            <input type="radio" name="aanhef" value="geen" required />
      ...
      <div class="mb-4">
        ...
        >
          <textarea class="hidden" id="hiddeninput" name="hiddeninput"
          ></textarea>
          Ik heb een vraag over
          <span class="text-primary-500">Blababa</span>. Wil jij contact met mij
          opnemen?
        </div>
      </div>
      <div class="mt-4 flex justify-end">
        <Button role="primary" disabled>Versturen</Button>
      </div>
    </form>
  </div>
</div>
